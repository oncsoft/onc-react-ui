...
const Story = args => /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxDEV)(_Grid__WEBPACK_IMPORTED_MODULE_1__["default"], {
  container: true,
  direction: 'row',
  ...args,
  style: {
...
Docs.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "args => <Grid container direction={'row'} {...args} style={{\n  background: 'red',\n  width: 600\n}}>\n    <Grid item={1}>1</Grid>\n    <Grid item={2}>2</Grid>\n    <Grid item={9}>3</Grid>\n  </Grid>",
